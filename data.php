...
$lots = [
    ...
    [
        ...
        'image' => 'img/lot-2.jpg',
        'bets' => $bets,
        'description' => 'Уникальность этой доски в ее форме. Сноуборд с классическим кембер прогибом,
    ...
    [
        ...
        'image' => 'img/lot-3.jpg',
        'bets' => $bets,
        'description' => 'Крепления Union Contact созданы для тех, кто видит споты повсюду:
    ...
    [
        ...
        'image' => 'img/lot-4.jpg',
        'bets' => $bets,
        'description' => 'Прогрессивный дизайн в классическом силуэте - ботинки DC Mutiny созданы для
    ...
    [
        ...
        'image' => 'img/lot-5.jpg',
        'bets' => $bets,
        'description' => 'Под лаконичным дизайном этой крутки скрывается отличный катальный функционал,
    ...
    [
        ...
        'image' => 'img/lot-6.jpg',
        'bets' => $bets,
        'description' => 'Маска Oakley с широким углом обзора и удобной быстрой системой замены линз.'
    ]
];
