        ...
        <?php foreach ($visited_lots as $key): ?>
            <li class="lots__item lot">
                ...
                <div class="lot__info">
                    ...
                    <h3 class="lot__title">
                        <a class="text-link" href="lot.php?id=<?=$lots[$key]; ?>"><?=htmlspecialchars($lots[$key]['name']); ?></a>
                    </h3>
                    <div class="lot__state">
                        <div class="lot__rate">
                            <span class="lot__amount">Стартовая цена</span>
                            <span class="lot__cost"><?=formatSum(htmlspecialchars($lots[$key]['lot-rate'])); ?></span>
                        </div>
                        <div class="lot__timer timer">
                            <?=countRemainingTime($lots[$key]['lot-date']); ?>
                        </div>
                    </div>
                </div>
            </li>
